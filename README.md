...
3. Заполните `host`, `port`, `timeout`, `scan_interval`, `unavailable_grace_period` и при необходимости включите `ignore_zero_counter_values` для фильтрации шумовых нулей счетчиков.
